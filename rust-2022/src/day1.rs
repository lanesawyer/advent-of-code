...
impl Day for Day1 {
    ...
    fn part_2(input: &str) -> Option<Answer> {
        ...
        Some(calorie_counts[0] + calorie_counts[1] + calorie_counts[2])
    }
}
...
mod tests {
    ...
    fn part1_works() {
        let test_input = r#"1000
            ...
            10000"#;
        assert_eq!(Day1::part_1(test_input), Some(24000));
    }
    ...
    fn part2_works() {
        let test_input = r#"1000
            ...
            10000"#;
        assert_eq!(Day1::part_2(test_input), Some(45000));
    }
}
